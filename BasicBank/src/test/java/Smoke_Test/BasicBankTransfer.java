...
public class BasicBankTransfer {

    static WebDriver driver;

    public BasicBankTransfer(WebDriver driver){

        this.driver=driver;
    }

    public static void transfer_Basic() throws InterruptedException{
        ...
        //Select Basic Bank Account Transfer
        WebElement own_Account = driver.findElement(By.xpath("//a[contains(text(),'BASIC Bank Account Transfer')]"));
        own_Account.click();
        Thread.sleep(3000);
        ...
        Thread.sleep(3000);
        act.sendKeys(Keys.TAB).build().perform();
        act.sendKeys("0214010043513").build().perform();
        act.sendKeys(Keys.TAB).build().perform();
        Thread.sleep(3000);
        ...
        //Success Message
        WebElement successMsg = driver.findElement(By.xpath("//h6[contains(text(),'BASIC Bank Fund Transfer Successful')]"));
        String expMsg = "BASIC Bank Fund Transfer Successful";
        //System.out.println(successMsg.getText());

        if(expMsg.equals(successMsg.getText())){

            System.out.println("Basic Bank Fund Transfer - Test passed");

        }else {
            System.out.println("Basic Bank Fund Transfer - Test Failed");
        }
